...
G4LogicalVolume *Logic_HPGeCrystal_Walid;

void DefineHPGeCrystal_Walid()
{
    ...
    */
    ...
    G4double length_head2 = (4.5/atan(7.1*deg)); // 4.5 = total enlevé vers lavant de la face tapered
    G4double rinner[5] = {0,0,0,0,0};
    G4double router[5] = {20.5*mm,23.*mm,24.83012702*mm,25.5*mm,25.5*mm};
    G4double router2[5] = {20.5*mm,23.*mm,24.83012702*mm,25.0*mm,25.0*mm};
    ...
    G4Tubs* cylduvid = new G4Tubs("cylvid", 0.*cm, 5.5*mm,4*cm,0.*deg, 360.*deg);
    ...
    G4ThreeVector videtransGe701(0*cm, 0.*cm,-(40. +5.5 +(70.1-length_head) - 55.5 )*mm);
    G4ThreeVector videtransGe700(0*cm, 0.*cm,-(40. +5.5 +(70.0-length_head) - 55.5 )*mm);
    G4ThreeVector videtransGe699(0*cm, 0.*cm,-(40. +5.5 +(69.9-length_head) - 55.5 )*mm);
    G4ThreeVector videtransGe698(0*cm, 0.*cm,-(40. +5.5 +(69.8-length_head) - 55.5 )*mm);
    G4ThreeVector videtransGe695(0*cm, 0.*cm,-(40. +5.5 +(69.5-length_head) - 55.5 )*mm);
    G4ThreeVector videtransGe6994(0*cm, 0.*cm,-(40. +5.5 +(69.94-length_head) - 55.5 )*mm);
    G4ThreeVector videtransGe7015(0*cm, 0.*cm,-(40. +5.5 +(70.15-length_head) - 55.5 )*mm);
    ...
    G4Tubs* cylduvid7015 = new G4Tubs("cylvid", 0.55*cm, 6*mm,50.*0.5*mm,0.*deg, 360.*deg);
    G4Tubs* cylduvid701 = new G4Tubs("cylvid", 0.55*cm, 6*mm,50.*0.5*mm,0.*deg, 360.*deg);
    G4Tubs* cylduvid700 = new G4Tubs("cylvid", 0.55*cm, 6*mm,50.*0.5*mm,0.*deg, 360.*deg);
    G4Tubs* cylduvid699 = new G4Tubs("cylvid", 0.55*cm, 6*mm,50.*0.5*mm,0.*deg, 360.*deg);
    G4Tubs* cylduvid698 = new G4Tubs("cylvid", 0.55*cm, 6*mm,50.*0.5*mm,0.*deg, 360.*deg);
    G4Tubs* cylduvid695 = new G4Tubs("cylvid", 0.55*cm, 6*mm,50.*0.5*mm,0.*deg, 360.*deg);
    G4Tubs* cylduvid6994 = new G4Tubs("cylvid", 0.55*cm, 6*mm,50.*0.5*mm,0.*deg, 360.*deg);
    ...
    G4Sphere* teteduvid2 = new G4Sphere("tetvid",0.55*cm, 0.6*cm, 0.*deg,360*deg,0*deg,90*deg);
    
    G4ThreeVector videtrans7015(0*cm, 0.*cm,50*0.5*mm);
    G4ThreeVector videtrans701(0*cm, 0.*cm,50*0.5*mm);
    G4ThreeVector videtrans700(0*cm, 0.*cm,50*0.5*mm);
    G4ThreeVector videtrans699(0*cm, 0.*cm,50*0.5*mm);
    G4ThreeVector videtrans698(0*cm, 0.*cm,50*0.5*mm);
    G4ThreeVector videtrans695(0*cm, 0.*cm,50*0.5*mm);
    G4ThreeVector videtrans6994(0*cm, 0.*cm,50*0.5*mm);
    
    G4RotationMatrix* rotvid2 = new G4RotationMatrix;
    
    G4UnionSolid* partievideLi7015 = new G4UnionSolid("cylvid+tetvid",cylduvid7015,teteduvid2,rotvid2,videtrans7015);
    G4UnionSolid* partievideLi701 = new G4UnionSolid("cylvid+tetvid",cylduvid701,teteduvid2,rotvid2,videtrans701);
    G4UnionSolid* partievideLi700 = new G4UnionSolid("cylvid+tetvid",cylduvid700,teteduvid2,rotvid2,videtrans700);
    G4UnionSolid* partievideLi699 = new G4UnionSolid("cylvid+tetvid",cylduvid699,teteduvid2,rotvid2,videtrans699);
    G4UnionSolid* partievideLi698 = new G4UnionSolid("cylvid+tetvid",cylduvid698,teteduvid2,rotvid2,videtrans698);
    G4UnionSolid* partievideLi695 = new G4UnionSolid("cylvid+tetvid",cylduvid695,teteduvid2,rotvid2,videtrans695);
    G4UnionSolid* partievideLi6994 = new G4UnionSolid("cylvid+tetvid",cylduvid6994,teteduvid2,rotvid2,videtrans6994);
    ...
    G4ThreeVector LiTrans7015(0*cm, 0.*cm,-((50.*0.5) + 6 +(70.15-length_head) -55.5 ) *mm);
    G4ThreeVector LiTrans701(0*cm, 0.*cm,-((50.*0.5) + 6 +(70.1-length_head) -55.5 ) *mm);
    G4ThreeVector LiTrans700(0*cm, 0.*cm,-((50.*0.5) + 6 +(70.0-length_head) -55.5 ) *mm);
    G4ThreeVector LiTrans699(0*cm, 0.*cm,-((50.*0.5) + 6 +(69.9-length_head) -55.5 ) *mm);
    G4ThreeVector LiTrans698(0*cm, 0.*cm,-((50.*0.5) + 6 +(69.8-length_head) -55.5 ) *mm);
    G4ThreeVector LiTrans695(0*cm, 0.*cm,-((50.*0.5) + 6 +(69.5-length_head) -55.5 ) *mm);
    G4ThreeVector LiTrans6994(0*cm, 0.*cm,-((50.*0.5) + 6 +(69.94-length_head) -55.5 ) *mm);
    ...
    G4SubtractionSolid * cristalGe701 = new G4SubtractionSolid("cristal 3g",cristal701, partievide, rotz701, videtransGe701);
    ...
    G4SubtractionSolid * cristalGe700 = new G4SubtractionSolid("cristal 2 g",cristal700, partievide, rotz701, videtransGe700);
